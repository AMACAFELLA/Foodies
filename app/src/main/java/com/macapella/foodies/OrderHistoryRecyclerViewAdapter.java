...
public class OrderHistoryRecyclerViewAdapter extends RecyclerView.Adapter<OrderHistoryRecyclerViewAdapter.viewHolder> {
    ...
    public OrderHistoryRecyclerViewAdapter(Context mContext, List<OrderModel> mData) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        v = inflater.inflate(R.layout.order_history_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull OrderHistoryRecyclerViewAdapter.viewHolder holder, int position) {
        ...
        holder.viewDetails.setOnClickListener(
                (view) -> {
                    Intent intent = new Intent(holder.context, OrderHistoryDetailsActivity.class);
    ...
    public static class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            name = itemView.findViewById(R.id.orderHistoryName);
            orderNumber = itemView.findViewById(R.id.orderHistoryNumber);
            status = itemView.findViewById(R.id.orderHistoryStatus);
            total = itemView.findViewById(R.id.orderHistoryTotal);
            viewDetails = itemView.findViewById(R.id.viewOrderDetails);
